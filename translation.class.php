...
*/
	function Translation($PageName, $LanguageID, $pear_DSN, $CustomTables = 0) {
		...
		if (is_array($CustomTables["langsavail"])) {
			$this->TableDefinitions["langsavail"]["name"] = (isset($CustomTables["langsavail"]["name"]) ? isset($CustomTables["langsavail"]["name"]) : 'tr_langsavail');
			$this->TableDefinitions["langsavail"]["lang_id"] = (isset($CustomTables["langsavail"]["lang_id"]) ? isset($CustomTables["langsavail"]["lang_id"]) : 'lang_id');
			$this->TableDefinitions["langsavail"]["lang_name"] = (isset($CustomTables["langsavail"]["lang_name"]) ? isset($CustomTables["langsavail"]["lang_name"]) : 'lang_name');
			$this->TableDefinitions["langsavail"]["metatags"] = (isset($CustomTables["langsavail"]["metatags"]) ? isset($CustomTables["langsavail"]["metatags"]) : 'metatags');
			$this->TableDefinitions["langsavail"]["errortext"] = (isset($CustomTables["langsavail"]["errortext"]) ? isset($CustomTables["langsavail"]["errortext"]) : 'errortext');
		}
